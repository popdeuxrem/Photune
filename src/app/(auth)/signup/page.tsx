      ...
      <div className="w-full max-w-[400px] space-y-8">
        ...
        <div className="bg-white p-8 rounded-[32px] shadow-2xl shadow-zinc-200 border border-zinc-100">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-2 text-zinc-400 font-bold">Or use email</span></div>
          </div>
          <SignUpForm />
        </div>

        <p className="text-center text-sm text-zinc-500">
          Already a member? <Link href="/login" className="text-zinc-900 font-bold hover:underline">Sign In</Link>
        </p>
      </div>
    </div>
  );
