...
import { Crown, Zap, Check, Loader2, CreditCard } from 'lucide-react';
      ...
      <DialogContent className="max-w-md bg-white dark:bg-zinc-900 rounded-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-zinc-500 dark:text-zinc-400">
            Unlock {feature} with Photune Pro.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center justify-center gap-1 pt-2 border-t border-zinc-200 dark:border-zinc-700 text-xs text-zinc-400">
          <CreditCard size={14} />
          Stripe
        </div>
