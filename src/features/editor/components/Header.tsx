...
export function Header({ projectId, projectName }: { projectId: string; projectName: string }) {
  ...
  return (
    <header className="h-14 border-b bg-white flex items-center justify-between px-4 shrink-0 shadow-sm z-20">
      ...
      <div className="text-sm font-bold text-zinc-700 bg-zinc-100 px-3 py-1 rounded-full border border-zinc-200">
        {projectName}
      </div>
